...
<template>
  <CardPanel class="containerWrapper" style="height: 100%">
    ...
    <template #body>
      ...
      <a-typography-paragraph> {{ t("TXT_CODE_68831be6") }}{{ instanceTypeText }} </a-typography-paragraph>
      <a-typography-paragraph>
      ...
      <a-typography-paragraph>
        ...
        <span class="ml-6">{{ t("TXT_CODE_400a4210") }}{{ instanceInfo?.config.ie.toUpperCase() }} </span>
      </a-typography-paragraph>
    </template>
  </CardPanel>
</template>
