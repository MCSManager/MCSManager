...
class Locale {
  ...
  private static userLocale: { [key: string]: string } = {}
  ...
  public static changeLanguage(locale: string): void {
    Locale.DefaultLocale = locale;
    Locale.userLocale = JSON.parse(Locale.ReadLanguageFile(locale));
  }

  public static t(...args: any[]): string {
    return args.length == 1 ? Locale.userLocale[args[0]]: Locale.Parser(Locale.userLocale[args[0]], args[1]);
  }
}
