...
[![Status](https://img.shields.io/badge/npm-v5.9.0-blue.svg)](https://www.npmjs.com/)
[![Status](https://img.shields.io/badge/node-v10.0-blue.svg)](https://nodejs.org/en/download/)
...
Node 10.0 以上，无需数据库和更改任何系统配置，开箱运行。
