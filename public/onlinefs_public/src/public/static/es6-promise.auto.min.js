!(function (t, e) {
  ...
  function x(t, n, r, o) {
    ...
    if (i) {
      if (
        ((s = P(r, o)),
        s === ot ? ((a = !0), (u = s.error), (s.error = null)) : (c = !0),
        n === s)
      )
        return void j(n, d());
    } else (s = o), (c = !0);
  ...
  Z = R
    ...
    : V
    ? u()
    : void 0 === I && "function" == typeof require
    ? f()
    : c();
    ...
    st = (function () {
      ...
      return (
        ...
        (t.prototype._settledAt = function (t, e, n) {
          var r = this.promise;
          r._state === tt &&
            (this._remaining--, t === nt ? j(r, n) : (this._result[e] = n)),
