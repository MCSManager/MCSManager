	    ...
	    filesOperate: function filesOperate(item) {
	      ...
	      switch (item.name) {
	        ...
	        case "粘贴":
	          ...
	          break;
	        case "删除":
	          var filestack = this.getFileStack(); //BUG Note:this上下文不可出现在异步
