    ...
    (e.prototype = {
      ...
      _buildShape: function () {
        ...
        for (
          ...
          if (((e = t[l]), (i = e.name), e.type === o.CHART_TYPE_SCATTER)) {
            if (
              ...
              if (
                ((this.selectedMap[i] = r.isSelected(i)),
                (this._sIndex2ColorMap[l] = a.alpha(r.getColor(i), 0.5)),
                (s = r.getItemShape(i)))
              ) {
                var n = this._sIndex2ShapeMap[l];
                (s.style.brushType = n.match("empty") ? "stroke" : "both"),
                  (n = n.replace("empty", "").toLowerCase()),
                  n.match("rectangle") &&
                    ((s.style.x += Math.round(
                      (s.style.width - s.style.height) / 2
                    )),
                    (s.style.width = s.style.height)),
                  n.match("star") &&
                    ((s.style.n = n.replace("star", "") - 0 || 5),
                    (n = "star")),
                  n.match("image") &&
                    ((s.style.image = n.replace(
                      new RegExp("^image:\\/\\/"),
                      ""
                    )),
                    (s.style.x += Math.round(
              ...
              (this.selectedMap[i] = !0),
                (this._sIndex2ColorMap[l] = a.alpha(this.zr.getColor(l), 0.5));
        ...
        if (0 !== t.length) {
          for (
            ...
            if (((e = t[c]), (i = l[e]), 0 !== i.data.length)) {
              (n = this.component.xAxis.getAxis(i.xAxisIndex || 0)),
                (a = this.component.yAxis.getAxis(i.yAxisIndex || 0)),
                (d[e] = []);
              for (var u = 0, g = i.data.length; g > u; u++)
                (s = i.data[u]),
                  (o = this.getDataFromOption(s, "-")),
                  "-" === o ||
                    o.length < 2 ||
                    ((r = n.getCoord(o[0])),
                    (h = a.getCoord(o[1])),
                    d[e].push([r, h, u, s.name || ""]));
              (this.xMarkMap[e] = this._markMap(n, a, i.data, d[e])),
                this.buildMark(e);
            }
          this._buildPointList(d);
        }
      },
      _markMap: function (t, e, i, s) {
        for (
          var o,
            n = {
          ...
          (o = i[s[a][2]].value || i[s[a][2]]),
            n.min0 > o[0] &&
              ((n.min0 = o[0]), (n.minY0 = s[a][1]), (n.minX0 = s[a][0])),
            n.max0 < o[0] &&
              ((n.max0 = o[0]), (n.maxY0 = s[a][1]), (n.maxX0 = s[a][0])),
            (n.sum0 += o[0]),
            n.counter0++,
            n.min1 > o[1] &&
              ((n.min1 = o[1]), (n.minY1 = s[a][1]), (n.minX1 = s[a][0])),
            n.max1 < o[1] &&
              ((n.max1 = o[1]), (n.maxY1 = s[a][1]), (n.maxX1 = s[a][0])),
            (n.sum1 += o[1]),
            n.counter1++;
        ...
        n.average0 = n.sum0 / n.counter0;
        var p = t.getCoord(n.average0);
        (n.averageLine0 = [
          [p, c],
          [p, d],
        ]),
          ...
          (n.average1 = n.sum1 / n.counter1);
        var u = e.getCoord(n.average1);
        return (
          (n.averageLine1 = [
            [h, u],
            [l, u],
            ...
            this.shapeList.push(
              this._getLargeSymbol(
                ...
                this.getItemStyleColor(
                  ...
                  a,
                  -1
                ) || this._sIndex2ColorMap[a]
              )
            );
          else
            for (var r = 0, h = i.length; h > r; r++)
              (s = i[r]),
                (o = this._getSymbol(a, s[2], s[3], s[0], s[1])),
                o && this.shapeList.push(o);
      },
      _getSymbol: function (t, e, i, s, o) {
        var n,
          a = this.series,
          r = a[t],
          h = r.data[e],
        ...
        if (l) {
          if (
            ((n = isNaN(h[2]) ? this._sIndex2ColorMap[t] : l.getColor(h[2])),
            !n)
          )
            return null;
        } else n = this._sIndex2ColorMap[t];
      ...
      _getLargeSymbol: function (t, e) {
        return new s({
          zlevel: this.getZlevelBase(),
          z: this.getZBase(),
          _main: !0,
          hoverable: !1,
          style: { pointList: t, color: e, strokeColor: e },
      ...
      getMarkCoord: function (t, e) {
        var i,
          s = this.series[t],
          o = this.xMarkMap[t],
          n = this.component.xAxis.getAxis(s.xAxisIndex),
          a = this.component.yAxis.getAxis(s.yAxisIndex);
        if (
          !e.type ||
          ...
          var r = null != e.valueIndex ? e.valueIndex : 1;
          i = [
            o[e.type + "X" + r],
            o[e.type + "Y" + r],
            o[e.type + "Line" + r],
      ...
      (e.prototype = {
          ...
          for (var d, h = 0, l = t.length; l > h; h++)
            if (
              ...
              for (var c = 0, p = s.length; p > c; c++)
                if (s[c] == (d.xAxisIndex || 0)) {
                  n.push(h);
                  break;
                }
              for (var c = 0, p = o.length; p > c; c++)
                if (o[c] == (d.yAxisIndex || 0)) {
                  n.push(h);
                  break;
                }
        ...
        _buildBackground: function () {
          ...
          for (
            ...
            (p = this.getDataFromOption(g[h], 0)),
              this.option.series[u].type == a.CHART_TYPE_K && (p = p[1]),
              isNaN(p) && (p = 0),
              (f = Math.max(f, p)),
              (m = Math.min(m, p));
          var y = f - m,
        ...
        _getDetail: function () {
          ...
          if ("time" == d) {
            ...
            var g = r.getAutoFormatter(c, p).formatter;
            return { start: r.format(g, c), end: r.format(g, p) };
          }
          return { start: "", end: "" };
        },
  ...
  define("echarts/component/dataRange", [
    ...
    function e(t, e, s, o, n) {
      ...
      (r._ondrift = function (t, e) {
        ...
        (this._range = {}),
        this.refresh(o),
        e.bind(a.EVENT.HOVER, this._onhoverlink);
    }
    var i = t("./base"),
      s = t("zrender/shape/Text"),
      o = t("zrender/shape/Rectangle"),
      n = t("../util/shape/HandlePolygon"),
      a = t("../config");
    a.dataRange = {
      zlevel: 0,
      z: 4,
    ...
    return (
      (e.prototype = {
        type: a.COMPONENT_TYPE_DATARANGE,
        _textGap: 10,
        _buildShape: function () {
          if (
        ...
        _buildItem: function () {
          ...
          "vertical" == this.dataRangeOption.orient &&
            ...
            (d = this._itemGroupLocation.x + this._itemGroupLocation.width - p);
          var m = !0;
          ...
          for (var y = 0; r > y; y++)
            (t = a[y]),
              (n = this.getColorByIndex(y)),
              (e = this._getItemShape(
                d,
                c,
                p,
                u,
                this._selectedMap[y] ? n : "#ccc"
              )),
              (e._idx = y),
              ...
              m &&
                ...
                this.shapeList.push(new s(i))),
              "horizontal" == this.dataRangeOption.orient
                ? (d += p + (m ? 5 : 0) + (m ? l.getTextWidth(t, h) : 0) + g)
                : (c += u + g);
          !m &&
        ...
        _buildGradient: function () {
          var e,
            i,
            n = this.getFont(this.dataRangeOption.textStyle),
            a = this._itemGroupLocation.x,
            r = this._itemGroupLocation.y,
            h = this.dataRangeOption.itemWidth,
            d = this.dataRangeOption.itemHeight,
            c = l.getTextHeight("国", n),
            p = 6,
            u = !0;
          this.dataRangeOption.text &&
            ((u = !1),
            this.dataRangeOption.text[0] &&
              ((i = this._getTextShape(a, r, this.dataRangeOption.text[0])),
              "horizontal" == this.dataRangeOption.orient
                ? (a +=
                    l.getTextWidth(this.dataRangeOption.text[0], n) +
                    this._textGap)
                : ((r += c + this._textGap),
          ...
          for (
            ...
            m.push([y * f, this.dataRangeOption.color[y]]);
          "horizontal" == this.dataRangeOption.orient
            ? ((e = {
                zlevel: this.getZlevelBase(),
                z: this.getZBase(),
                style: {
                  ...
                  width: h * p,
                  height: d,
                  color: g.getLinearGradient(a, r, a + h * p, r, m),
                },
                hoverable: !1,
              }),
              (a += h * p + this._textGap))
            : ((e = {
                ...
                style: {
                  ...
                  width: h,
                  height: d * p,
                  color: g.getLinearGradient(a, r, a, r + d * p, m),
                },
                hoverable: !1,
              }),
              (r += d * p + this._textGap)),
            ...
            !u &&
              this.dataRangeOption.text[1] &&
              ((i = this._getTextShape(a, r, this.dataRangeOption.text[1])),
              this.shapeList.push(new s(i)));
        },
        _buildIndicator: function () {
          ...
          "horizontal" == this.dataRangeOption.orient
            ...
            (this._indicatorShape = new n(this._indicatorShape));
        },
        _buildFiller: function () {
          (this._fillerShape = {
            zlevel: this.getZlevelBase(),
          ...
          "horizontal" == this.dataRangeOption.orient
            ? "bottom" != this.dataRangeOption.y
              ? ((t = [
                ...
                (e = d - m / 2 - f),
                (i = c + u + f / 2 + 2),
                (s = { x: d - m - f, y: c + u, width: m + f, height: f }),
                (o = [
                  [d + p, c],
                  [d + p, c + u + f],
                  [d + p + f, c + u + f],
              ...
              : ((t = [
                ...
                (e = d - m / 2 - f),
                (i = c - f / 2 - 2),
                (s = { x: d - m - f, y: c - f, width: m + f, height: f }),
                (o = [
                  [d + p, c + u],
                  [d + p, c - f],
                  [d + p + f, c - f],
            ...
            : ((m += f),
              "right" != this.dataRangeOption.x
                ? ((t = [
                  ...
                  (e = d + p + m / 2 + f / 2),
                  (i = c - f / 2),
                  (s = { x: d + p, y: c - f, width: m + f, height: f }),
                  (o = [
                    [d, c + u],
                    [d + p + f, c + u],
                    [d + p + f, c + f + u],
                ...
                : ((t = [
                  ...
                  (a = e),
                  (r = c + u + f / 2),
                  (h = { x: d - m - f, y: c + u, width: m + f, height: f }))),
            (this._startShape = {
              style: {
                pointList: t,
        ...
        _getItemGroupLocation: function () {
          ...
          if ("horizontal" == this.dataRangeOption.orient) {
            if (
              ...
              s += 5;
              for (var c = 0; e > c; c++) n += s + l.getTextWidth(t[c], r) + i;
            }
            (n -= i), (a = Math.max(h, o));
          } else {
            var p;
            if (
              ...
              (a = (o + i) * e), (s += 5), (p = 0);
              for (var c = 0; e > c; c++)
                p = Math.max(p, l.getTextWidth(t[c], r));
              n = s + p;
            }
            a -= i;
          }
          ...
          switch (this.dataRangeOption.x) {
            ...
            case "left":
              ...
              break;
            case "right":
              u = f - n - g[1] - this.dataRangeOption.borderWidth;
              break;
            default:
          ...
          switch (this.dataRangeOption.y) {
            case "top":
              ...
              break;
            case "bottom":
              m = y - a - g[2] - this.dataRangeOption.borderWidth;
              break;
            case "center":
              m = Math.floor((y - a) / 2);
              break;
            default:
              (m = this.parsePercent(this.dataRangeOption.y, y)),
                (m = isNaN(m) ? 0 : m);
          }
          ...
          return { x: u, y: m, width: n, height: a };
        },
        ...
        __ondrift: function (t, e, i) {
          ...
          return (
            "horizontal" == this.dataRangeOption.orient
              ? t.style.x + e <= s
                ? (t.style.x = s)
                : t.style.x + e + t.style.width >= s + n
                ? (t.style.x = s + n - t.style.width)
                : (t.style.x += e)
              : t.style.y + i <= o
              ? (t.style.y = o)
              : t.style.y + i + t.style.height >= o + a
              ? (t.style.y = o + a - t.style.height)
              : (t.style.y += i),
            "filler" == t._type
              ? this._syncHandleShape()
        ...
        _syncFillerShape: function (t) {
          ...
          "horizontal" == this.dataRangeOption.orient
            ? ((e = this._startShape.style.x),
              ...
              (this._endMask.style.width = s + n - i),
              (this._range.start = Math.ceil(100 - ((e - s) / n) * 100)),
              (this._range.end = Math.floor(100 - ((i - s) / n) * 100)))
            : ((e = this._startShape.style.y),
              ...
              (this._endMask.style.height = o + a - i),
              (this._range.start = Math.ceil(100 - ((e - o) / a) * 100)),
              (this._range.end = Math.floor(100 - ((i - o) / a) * 100))),
            this._syncShape();
        },
        _syncShape: function () {
          ...
          if (t) {
            ...
            if (
              ...
              for (
                ...
                s.push(this._colorList[Math.floor(n * o)]);
              s.push(this._colorList[i - 1]), (this._colorList = s);
            }
            var a = this.dataRangeOption.precision;
            for (
              this._gap =
                (this.dataRangeOption.max - this.dataRangeOption.min) / e;
              this._gap.toFixed(a) - 0 != this._gap && 5 > a;

            )
              a++;
            (this.dataRangeOption.precision = a),
              (this._gap =
                (
                  (this.dataRangeOption.max - this.dataRangeOption.min) /
                  e
            ...
            for (var n = 0; e > n; n++)
              (this._selectedMap[n] = !0),
                this._valueTextList.unshift(
                  this._textFormat(
                    n * this._gap + this.dataRangeOption.min,
                    (n + 1) * this._gap + this.dataRangeOption.min
                  )
                );
          }
        ...
        onbeforDispose: function () {
          this.messageCenter.unbind(a.EVENT.HOVER, this._onhoverlink);
        },
      }),
      r.inherits(e, i),
            ...
            if (this.isHorizontal())
              if (s > 3) {
                ...
                for (d = 1 > d ? 1 : d, t = Math.floor(15 / a); !l && s > t; ) {
                  ...
                  for (var c = Math.floor((s - 1) / t) * t; c >= 0; c -= t) {
        ...
        _buildSplitLine: function () {
          ...
          if (
            ...
            for (
              ...
              (!l || l(f, e[f])) &&
                ((p = this.subPixelOptimize(this.getCoordByIndex(f) + c, a)),
                (t = {
                  zlevel: this.getZlevelBase(),
                  z: this.getZBase(),
                  hoverable: !1,
            ...
            for (
              ...
              (!l || l(f, e[f])) &&
                ((m = this.subPixelOptimize(this.getCoordByIndex(f) - c, a)),
                (t = {
                  zlevel: this.getZlevelBase(),
                  z: this.getZBase(),
                  hoverable: !1,
          ...
          if (s instanceof Array) {
            ...
            if (this.isHorizontal())
              ...
              for (
                ...
                (r && !r(g, e[g]) && a > g) ||
                  ((f = a > g ? this.getCoordByIndex(g) - l : this.grid.getY()),
                  (t = {
                    zlevel: this.getZlevelBase(),
                    z: this.getZBase(),
                    hoverable: !1,
      ...
      (e.prototype = {
        ...
        _buildAxisTick: function () {
          ...
          if (this.isHorizontal())
            ...
            for (
              ...
              (c = this.subPixelOptimize(this.getCoord(e[d]), r)),
                (t = {
                  _axisShape: "axisTick",
                  zlevel: this.getZlevelBase(),
                  z: this.getZBase(),
        ...
        _buildSplitLine: function () {
          ...
          if (this.isHorizontal())
            for (
              ...
              (l = this.subPixelOptimize(this.getCoord(e[p]), a)),
                (t = {
                  zlevel: this.getZlevelBase(),
                  z: this.getZBase(),
                  hoverable: !1,
            ...
            for (
              ...
              (u = this.subPixelOptimize(this.getCoord(e[p]), a)),
                (t = {
                  zlevel: this.getZlevelBase(),
                  z: this.getZBase(),
                  hoverable: !1,
          ...
          if (e instanceof Array) {
            ...
            if (this.isHorizontal())
              ...
              for (
                ...
                (c = o > d ? this.getCoord(s[d]) : this.grid.getY()),
                  (t = {
                    zlevel: this.getZlevelBase(),
                    z: this.getZBase(),
                    hoverable: !1,
        ...
        _calculSum: function (t, e) {
          ...
          if (this.series[e].stack) {
            ...
            for (var l = 0, d = s.length; d > l; l++)
              for (var c = s[l].evolution, p = 0, u = c.length; u > p; p++)
                t[o].push(r.getNewDate(c[p].time));
          }
        },
