define("echarts/chart/bar", [
  ...
  return (
    (e.prototype = {
      type: s.CHART_TYPE_BAR,
      _buildShape: function () {
        this._buildPosition();
      },
      _buildNormal: function (t, e, i, n, r) {
        for (
          var a,
            h,
            l,
            ...
            L = S ? T.getAxis(b.xAxisIndex) : z.getAxis(b.yAxisIndex),
            C = this._mapSize(L, i),
            w = C.gap,
            M = C.barGap,
            A = C.barWidthMap,
            ...
            O = C.barMinHeightMap,
            I = C.interval,
            P = this.deepQuery([this.ecTheme, s], "island.r"),
            R = 0,
            D = e;
          D > R && null != L.getNameByIndex(R);
          R++
        ) {
          S
            ? (d = L.getCoordByIndex(R) - w / 2)
            : (c = L.getCoordByIndex(R) + w / 2);
          for (var B = 0, N = i.length; N > B; B++) {
            var H = v[i[B][0]].yAxisIndex || 0,
              Y = v[i[B][0]].xAxisIndex || 0;
            (a = S ? z.getAxis(H) : T.getAxis(Y)),
              (u = p = f = g = a.getCoord(0));
            for (var F = 0, W = i[B].length; W > F; F++)
              (x = i[B][F]),
                (b = v[x]),
                (y = b.data[R]),
                ...
                (l = Math.min(E[x] || Number.MAX_VALUE, A[x] || k)),
                "-" !== _ &&
                  (_ > 0
                    ? ((h =
                        F > 0
                    ...
                    ? ((h =
                      ...
                      1 === W && O[x] > h && (h = O[x]),
                      S ? ((c = g), (g += h)) : ((g -= h), (d = g)))
                    : ((h = 0), S ? ((p -= h), (c = p)) : ((d = p), (p += h))),
                  (n[x][R] = S ? d + l / 2 : c - l / 2),
                  n[x].min > _ &&
                    ((n[x].min = _),
                    S
                      ? ((n[x].minY = c), (n[x].minX = n[x][R]))
                      : ((n[x].minX = d + h), (n[x].minY = n[x][R]))),
                  n[x].max < _ &&
                    ((n[x].max = _),
                    S
                      ? ((n[x].maxY = c), (n[x].maxX = n[x][R]))
                      : ((n[x].maxX = d + h), (n[x].maxY = n[x][R]))),
                  (n[x].sum += _),
                  n[x].counter++,
                  R % I === 0 &&
                    ((m = this._getBarItem(
            ...
            for (var F = 0, W = i[B].length; W > F; F++)
              (x = i[B][F]),
                ...
                (l = Math.min(E[x] || Number.MAX_VALUE, A[x] || k)),
                "-" == _ &&
                  this.deepQuery([y, b, this.option], "calculable") &&
                  (S ? ((p -= P), (c = p)) : ((d = p), (p += P)),
                  (m = this._getBarItem(
                    x,
                    R,
        ...
        this._calculMarkMapXY(n, i, S ? "y" : "x");
      },
      ...
      _buildOther: function (t, e, i, s) {
        for (var n = this.series, r = 0, a = i.length; a > r; r++)
          for (var h = 0, l = i[r].length; l > h; h++) {
            ...
            for (var _ = 0, v = c.data.length; v > _; _++) {
              var x = c.data[_],
              ...
              if (b instanceof Array) {
                var S,
                  ...
                  L = m.getCoord(b[1]),
                  C = [x, c],
                  w = this.deepQuery(C, "barWidth") || 10,
                  M = this.deepQuery(C, "barHeight");
                null != M
                  ? ((S = "horizontal"),
                    b[0] > 0
                      ? ((w = z - g), (z -= w))
                      : (w = b[0] < 0 ? g - z : 0),
                    (T = this._getBarItem(d, _, b[0], z, L - M / 2, w, M, S)))
                  : ((S = "vertical"),
                    b[1] > 0
                      ? (M = y - L)
                      : b[1] < 0
                      ? ((M = L - y), (L -= M))
                      : (M = 0),
                    (T = this._getBarItem(d, _, b[0], z - w / 2, L, w, M, S))),
                  this.shapeList.push(new o(T)),
                  (z = u.getCoord(b[0])),
                  (L = m.getCoord(b[1])),
                  s[d].min0 > b[0] &&
                    ((s[d].min0 = b[0]), (s[d].minY0 = L), (s[d].minX0 = z)),
                  s[d].max0 < b[0] &&
                    ((s[d].max0 = b[0]), (s[d].maxY0 = L), (s[d].maxX0 = z)),
                  (s[d].sum0 += b[0]),
                  s[d].counter0++,
                  s[d].min1 > b[1] &&
                    ((s[d].min1 = b[1]), (s[d].minY1 = L), (s[d].minX1 = z)),
                  s[d].max1 < b[1] &&
                    ((s[d].max1 = b[1]), (s[d].maxY1 = L), (s[d].maxX1 = z)),
                  (s[d].sum1 += b[1]),
                  s[d].counter1++;
              }
            }
          }
        this._calculMarkMapXY(s, i, "xy");
      },
      _mapSize: function (t, e, i) {
        var o,
          s,
          n = this._findSpecialBarSzie(e, i),
          r = n.barWidthMap,
          a = n.barMaxWidthMap,
          h = n.barMinHeightMap,
          l = n.sBarWidthCounter,
          d = n.sBarWidthTotal,
          c = n.barGap,
          p = n.barCategoryGap,
          u = 1;
        if (e.length != l) {
          if (i)
            (o = t.getGap()),
              (c = 0),
              (s = +(o / e.length).toFixed(2)),
              0 >= s && ((u = Math.floor(e.length / o)), (s = 1));
          else if (
            ((o =
              "string" == typeof p && p.match(/%$/)
                ? ((t.getGap() * (100 - parseFloat(p))) / 100).toFixed(2) - 0
                : t.getGap() - p),
            "string" == typeof c && c.match(/%$/)
              ? ((c = parseFloat(c) / 100),
                (s = +((o - d) / ((e.length - 1) * c + e.length - l)).toFixed(
                  2
                )),
                (c = s * c))
              : ((c = parseFloat(c)),
                (s = +((o - d - c * (e.length - 1)) / (e.length - l)).toFixed(
                  2
                ))),
            0 >= s)
          )
          ...
          return this._mapSize(t, e, !0);
        return this._recheckBarMaxWidth(e, r, a, h, o, s, c, u);
      },
      _findSpecialBarSzie: function (t, e) {
        for (
          ...
          for (
            var g = { barWidth: !1, barMaxWidth: !1 }, f = 0, m = t[p].length;
            m > f;
            f++
          ) {
            var y = t[p][f],
            ...
            if (!e) {
              if (g.barWidth) a[y] = i;
                ...
                (a[y] = i), (c += i), d++, (g.barWidth = !0);
                for (var v = 0, x = f; x > v; v++) {
                  var b = t[p][v];
                  a[b] = i;
                }
              }
              if (g.barMaxWidth) h[y] = o;
              else if (((o = this.query(_, "barMaxWidth")), null != o)) {
                (h[y] = o), (g.barMaxWidth = !0);
                for (var v = 0, x = f; x > v; v++) {
                  var b = t[p][v];
                  h[b] = o;
                }
            ...
            (l[y] = this.query(_, "barMinHeight")),
              (s = null != s ? s : this.query(_, "barGap")),
              (n = null != n ? n : this.query(_, "barCategoryGap"));
          }
        return {
          barWidthMap: a,
          barMaxWidthMap: h,
      ...
      _recheckBarMaxWidth: function (t, e, i, o, s, n, r, a) {
      ...
      _getBarItem: function (t, e, i, o, s, r, h, l) {
        var d,
          c = this.series,
          p = c[t],
          u = p.data[e],
          ...
          y = this.deepMerge(f, "itemStyle.emphasis"),
          _ = m.barBorderWidth;
        d = {
        ...
        (d.highlightStyle.color =
          d.highlightStyle.color ||
          ("string" == typeof v.color ? a.lift(v.color, -0.3) : v.color)),
          (v.x = Math.floor(v.x)),
          (v.y = Math.floor(v.y)),
          (v.height = Math.ceil(v.height)),
          (v.width = Math.ceil(v.width)),
          _ > 0 && v.height > _ && v.width > _
            ? ((v.y += _ / 2), (v.height -= _), (v.x += _ / 2), (v.width -= _))
            : (v.brushType = "fill"),
          (d.highlightStyle.textColor = d.highlightStyle.color),
          (d = this.addLabel(d, p, u, i, l));
        var x = v.textPosition;
        if (
          "insideLeft" === x ||
          "insideRight" === x ||
          "insideTop" === x ||
          ...
          switch (x) {
            case "insideLeft":
              (v.textX = v.x + b),
                (v.textY = v.y + v.height / 2),
                (v.textAlign = "left"),
                (v.textBaseline = "middle");
              break;
            case "insideRight":
              (v.textX = v.x + v.width - b),
                (v.textY = v.y + v.height / 2),
                (v.textAlign = "right"),
                (v.textBaseline = "middle");
              break;
            case "insideTop":
              (v.textX = v.x + v.width / 2),
                (v.textY = v.y + b / 2),
                (v.textAlign = "center"),
                (v.textBaseline = "top");
              break;
            case "insideBottom":
              (v.textX = v.x + v.width / 2),
                (v.textY = v.y + v.height - b / 2),
                (v.textAlign = "center"),
                (v.textBaseline = "bottom");
          }
          (v.textPosition = "specific"), (v.textColor = v.textColor || "#fff");
        }
        return (
          this.deepQuery([u, p, this.option], "calculable") &&
            (this.setCalculable(d), (d.draggable = !0)),
          n.pack(d, c[t], t, c[t].data[e], e, i),
          d
        );
      },
      getMarkCoord: function (t, e) {
        var i,
          ...
          s = this.series[t],
          n = this.xMarkMap[t],
          r = this.component.xAxis.getAxis(s.xAxisIndex),
        ...
        if (
          ...
          var d =
            null != e.valueIndex ? e.valueIndex : null != n.maxX0 ? "1" : "";
          o = [
            n[e.type + "X" + d],
            n[e.type + "Y" + d],
            n[e.type + "Line" + d],
      ...
      addDataAnimation: function (t) {
        for (var e = this.series, i = {}, o = 0, s = t.length; s > o; o++)
          i[t[o][0]] = t[o];
        for (
          var r, a, h, l, d, c, p, o = this.shapeList.length - 1;
          o >= 0;
          o--
        )
          if (
            ((c = n.get(this.shapeList[o], "seriesIndex")),
            i[c] && !i[c][3] && "rectangle" === this.shapeList[o].type)
          ) {
            if (
              ((p = n.get(this.shapeList[o], "dataIndex")),
              (d = e[c]),
              i[c][2] && p === d.data.length - 1)
            ) {
            ...
            "horizontal" === this.shapeList[o]._orient
              ? ((l = this.component.yAxis.getAxis(d.yAxisIndex || 0).getGap()),
                (h = i[c][2] ? -l : l),
                (r = 0))
              : ((a = this.component.xAxis.getAxis(d.xAxisIndex || 0).getGap()),
                (r = i[c][2] ? a : -a),
                (h = 0)),
