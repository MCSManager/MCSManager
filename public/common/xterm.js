!(function (e, t) {
  ...
  return (function (e) {
      ...
      var o = r(7),
        ...
        a = (function (e) {
          function t() {
            ...
            return (
              (t.content = 0), (t.fg = 0), (t.bg = 0), (t.combinedData = ""), t
            );
          }
          return (
            n(t, e),
    ...
    function (e, t, r) {
      ...
      Object.defineProperty(t, "__esModule", { value: !0 }),
        ...
        (n.ensureContrastRatio = function (e, t, r) {
          ...
          if (i)
            return s.toColor((i >> 24) & 255, (i >> 16) & 255, (i >> 8) & 255);
        }),
        (n.opaque = function (e) {
          var t = (255 | e.rgba) >>> 0,
            r = s.toChannels(t),
    ...
    function (e, t, r) {
      ...
      function o(e, t, r) {
        t[i] === t
          ? t[n].push({ id: e, index: r })
          : ((t[n] = [{ id: e, index: r }]), (t[i] = t));
      }
        ...
        return (
          ...
          (e.prototype.insertCells = function (e, t, r, i) {
            ...
            if (
              ...
              for (
                var l = new o.CellData(), h = this.length - e - t - 1;
                h >= 0;
                --h
              )
          ...
          (e.prototype.deleteCells = function (e, t, r, i) {
            ...
            if (((e %= this.length), t < this.length - e)) {
              for (
                var l = new o.CellData(), h = 0;
                h < this.length - e - t;
                ++h
              )
                this.setCell(e + h, this.loadCell(e + t + h, l));
              for (h = this.length - t; h < this.length; ++h)
                this.setCell(h, r);
            } else for (h = e; h < this.length; ++h) this.setCell(h, r);
            e &&
              2 === this.getWidth(e - 1) &&
          ...
          (e.prototype.resize = function (e, t) {
            if (e !== this.length) {
              if (e > this.length) {
                ...
                (r = new Uint32Array(e * a)).set(this._data.subarray(0, e * a)),
                  (this._data = r);
        ...
        N = (function (e) {
          function t(t) {
            ...
            return (
              ...
              (r._bufferService = r._instantiationService.createInstance(
                D.BufferService
              )),
              r._instantiationService.setService(
                A.IBufferService,
              ...
              (r._coreService = r._instantiationService.createInstance(
                M.CoreService,
                function () {
          ...
          return (
            ...
            (t.prototype._enableWindowsMode = function () {
              ...
              if (!this._windowsMode) {
                ...
                t.push(
                  this.onLineFeed(
                    w.updateWindowsModeWrappedState.bind(
                      null,
                      this._bufferService
                    )
                  )
                  ...
                  t.push(
                    this.addCsiHandler({ final: "H" }, function () {
                      return (
                        w.updateWindowsModeWrappedState(e._bufferService), !1
                      );
                    })
                  ),
                  (this._windowsMode = {
            ...
            (t.prototype._setupOptionsListeners = function () {
              ...
              this.optionsService.onOptionChange(function (t) {
                ...
                switch (t) {
                  case "fontFamily":
                  case "fontSize":
                    null === (r = e._renderService) ||
                      void 0 === r ||
                      r.clear(),
                      null === (i = e._charSizeService) ||
                        void 0 === i ||
                        i.measure();
                    break;
                  case "cursorBlink":
                  ...
                  case "screenReaderMode":
                    e.optionsService.options.screenReaderMode
                      ...
                      : (null === (o = e._accessibilityManager) ||
                          void 0 === o ||
                          o.dispose(),
            ...
            (t.prototype._initGlobal = function () {
              ...
              this._bindKeys(),
                this.register(
                  d.addDisposableDomListener(this.element, "copy", function (
                    t
                  ) {
            ...
            (t.prototype.open = function (e) {
              ...
              (this._viewportElement = U.createElement("div")),
                ...
                this.register(
                  d.addDisposableDomListener(this.textarea, "focus", function (
                    e
                  ) {
            ...
            (t.prototype.bindMouse = function () {
              ...
              function i(e) {
                var r, i, n;
                if (
                  !(r = t._mouseService.getRawByteCoords(
                    e,
                    t.screenElement,
                    t.cols,
                    t.rows
              ...
              this._coreMouseService.onProtocolChange(function (t) {
                (e.mouseEvents = t),
                  ...
                  8 & t
                    ? n.mousemove ||
                      (r.addEventListener("mousemove", l), (n.mousemove = l))
    ...
    function (e, t, r) {
      ...
      Object.defineProperty(t, "__esModule", { value: !0 }),
        ...
        (t.handlePasteEvent = function (e, t, r, i) {
          e.stopPropagation(),
            e.clipboardData &&
              o(e.clipboardData.getData("text/plain"), t, r, i);
        }),
        (t.paste = o),
        ...
        C = (function (e) {
          function t(t, r, i, n, c, l, _, p, g, y, b) {
            ...
            (m._terminal = t),
              ...
              m._parser.setCsiHandler({ prefix: "?", final: "J" }, function (
                e
              ) {
                return m.eraseInDisplay(e);
              }),
              ...
              m._parser.setCsiHandler({ prefix: "?", final: "K" }, function (
                e
              ) {
                return m.eraseInLine(e);
              }),
              ...
              m._parser.setCsiHandler({ prefix: ">", final: "c" }, function (
                e
              ) {
              ...
              m._parser.setCsiHandler({ prefix: "?", final: "h" }, function (
                e
              ) {
              ...
              m._parser.setCsiHandler({ prefix: "?", final: "l" }, function (
                e
              ) {
              ...
              m._parser.setCsiHandler({ prefix: "?", final: "n" }, function (
                e
              ) {
          ...
          return (
                    ...
                    if (l)
                      (o.x = 0),
                        ...
                        o.y === o.scrollBottom + 1
                          ? (o.y--,
                            this._terminal.scroll(this._eraseAttrData(), !0))
              ...
              for (
                ...
                r.lines.splice(r.ybase + r.scrollBottom, 1),
                  r.lines.splice(
                    r.ybase + r.scrollTop,
                    0,
                    r.getBlankLine(u.DEFAULT_ATTR_DATA)
                  );
              this._dirtyRowService.markRangeDirty(r.scrollTop, r.scrollBottom);
            }),
                ...
                switch (e.params[i]) {
                  ...
                  case 66:
                    this._logService.debug(
                      ...
                      null === (t = this._terminal.viewport) ||
                        void 0 === t ||
                        t.syncScrollArea();
                    break;
                  case 9:
                  ...
                  case 1047:
                    this._bufferService.buffers.activateAltBuffer(
                      ...
                      null === (r = this._terminal.viewport) ||
                        void 0 === r ||
                        r.syncScrollArea(),
              ...
              return (
                38 === i[0]
                  ? 2 === i[1]
                    ? ((r.fg |= 50331648),
                      (r.fg &= -16777216),
                      (r.fg |= p.AttributeData.fromColorRGB([
                        i[3],
                        i[4],
                        i[5],
                      ])))
                    : 5 === i[1] &&
                      ((r.fg &= -50331904), (r.fg |= 33554432 | (255 & i[3])))
                  : 48 === i[0] &&
                    (2 === i[1]
                      ? ((r.bg |= 50331648),
                        (r.bg &= -16777216),
                        (r.bg |= p.AttributeData.fromColorRGB([
                          i[3],
                          i[4],
                          i[5],
                        ])))
            ...
            (t.prototype.charAttributes = function (e) {
              ...
              for (
                ...
                (t = e.params[n]) >= 30 && t <= 37
                  ...
                  : 0 === t
                  ? ((i.fg = u.DEFAULT_ATTR_DATA.fg),
                    (i.bg = u.DEFAULT_ATTR_DATA.bg))
                  : 1 === t
                  ? (i.fg |= 134217728)
                  : 3 === t
                  ? (i.bg |= 67108864)
                  ...
                  : 49 === t
                  ? ((i.bg &= -67108864),
                    (i.bg |= 16777215 & u.DEFAULT_ATTR_DATA.bg))
                  : 38 === t || 48 === t
            ...
            (t.prototype.keypadApplicationMode = function () {
              ...
              this._logService.debug(
                ...
                (this._coreService.decPrivateModes.applicationKeypad = !0),
                null === (e = this._terminal.viewport) ||
                  void 0 === e ||
                  e.syncScrollArea();
            }),
              ...
              2 === e.length
                ? "/" !== e[0] &&
                  this._charsetService.setgCharset(
                    b[e[0]],
                    s.CHARSETS[e[1]] || s.DEFAULT_CHARSET
                  )
          ...
          (r.prototype.parse = function (e, t) {
            for (
              ...
              switch ((i = l[(n << 8) | ((r = e[h]) < 160 ? r : 160)]) >> 4) {
                ...
                case 7:
                  for (
                    var f = this._csiHandlers[(a << 8) | r],
                      _ = f ? f.length - 1 : -1;
                    _ >= 0 && !1 === f[_](c);
                    _--
                  );
                  _ < 0 && this._csiHandlerFb((a << 8) | r, c),
                    (this.precedingCodepoint = 0);
                  break;
                case 8:
                  do {
                ...
                case 10:
                  for (
                    var d = this._escHandlers[(a << 8) | r],
                      p = d ? d.length - 1 : -1;
                    p >= 0 && !1 === d[p]();
                    p--
                  );
                  p < 0 && this._escHandlerFb((a << 8) | r),
                    (this.precedingCodepoint = 0);
                  break;
                case 11:
      ...
      var a = r(40),
        ...
        y = (function (e) {
          function t(t, r, i, n, o, s, f, _) {
            ...
            return (
              (d._characterJoinerRegistry = new u.CharacterJoinerRegistry(
                d._bufferService
              )),
              (d._renderLayers = [
        ...
        u = (function (e) {
          ...
          return (
            ...
            (t.prototype._drawForeground = function (e, t) {
              var r = this;
              this._forEachCell(e, t, this._characterJoinerRegistry, function (
                e,
                t,
                i
              ) {
    ...
    function (e, t, r) {
      ...
      var o = (function (e) {
        function t(t, r, i, n, o, s) {
          ...
          return (
            (a.bufferService = o), (a.optionsService = s), a._clearState(), a
          );
        }
        return (
          n(t, e),
              ...
              if ((this._clearAll(), e && t)) {
                ...
                if (!(o >= this._bufferService.rows || s < 0)) {
                  if (((this._ctx.fillStyle = this._colors.selection.css), r)) {
                    ...
                    if (
                      (this._fillCells(0, o + 1, this._bufferService.cols, u),
                      o !== s)
                    ) {
                  ...
                  if (
                    ...
                    this._ctx.save(),
                      this._cursorRenderers[
                        this._optionsService.options.cursorStyle || "block"
                      ](this._bufferService.buffer.x, r, this._cell),
                      this._ctx.restore(),
                      (this._state.x = this._bufferService.buffer.x),
                      (this._state.y = r),
                      (this._state.isFocused = !1),
                ...
                0 === h && ((h = this._bufferService.cols), u--),
                  this._mouseZoneManager.add(
                    new o(
                      ...
                      function () {
                        s._onLinkHover.fire(
                          s._createLinkHoverEvent(c, l, h, u, n)
                        ),
    ...
    function (e, t, r) {
      ...
      function n(e, t, r, i) {
        ...
        return h(
          Math.abs(n - s) -
            (function (e, t, r) {
              for (
                var i = 0, n = e - o(r, e), s = t - o(r, t), c = 0;
                c < Math.abs(n - s);
                c++
              ) {
                var l = "A" === a(e, t) ? -1 : 1,
      ...
      t.moveToCellSequence = function (e, t, r, i) {
        ...
        if (f === t)
          return (a = u > e ? "D" : "C"), h(Math.abs(u - e), l(a, i));
        a = f > t ? "D" : "C";
        var _ = Math.abs(f - t);
        return h(
          (function (e, t) {
        ...
        u = (function (e) {
          function t(t, r, i, n, o) {
            ...
            return (
              ...
              s.register(
                c.addDisposableDomListener(s._element, "mousedown", function (
                  e
                ) {
        ...
        y = (function (e) {
          function t(t, r, i, n, o, s, c, l) {
            ...
            return (
              ...
              h._refreshRowElements(
                h._bufferService.cols,
                h._bufferService.rows
              ),
              ...
              h._updateDimensions(),
              h._injectCss(),
              (h._rowFactory = new a.DomRendererRowFactory(
                document,
                h._optionsService,
                h._colors
              )),
          ...
          return (
            ...
            (t = o(
              [
                s(5, h.ICharSizeService),
                s(6, u.IOptionsService),
                s(7, u.IBufferService),
              ],
              t
            ))
          );
        ...
        return (
          ...
          (e.prototype.createRow = function (e, r, o, a, l, h, u) {
            for (
              ...
              if (
                e.loadCell(d, this._workCell).getCode() !== n.NULL_CELL_CODE ||
                (r && d === a)
              ) {
                _ = d + 1;
                break;
              ...
              if (0 !== p) {
                ...
                this._workCell.isBold() && v.classList.add(t.BOLD_CLASS),
                  ...
                  this._workCell.isInvisible()
                    ...
                    : (v.textContent =
                        this._workCell.getChars() || n.WHITESPACE_CELL_CHAR);
                ...
                switch (m) {
                  ...
                  default:
                    S &&
                      v.classList.add("xterm-bg-" + i.INVERTED_DEFAULT_COLOR);
                }
                f.appendChild(v);
              }
            }
    ...
    function (e, t, r) {
      ...
      t.updateWindowsModeWrappedState = function (e) {
        var t,
          r =
            null ===
              (t = e.buffer.lines.get(e.buffer.ybase + e.buffer.y - 1)) ||
            void 0 === t
              ? void 0
              : t.get(e.cols - 1),
          ...
          return (
            ...
            (e.prototype.splice = function (e, t) {
              ...
              for (n = this._length - 1; n >= e; n--)
                this._array[this._getCyclicIndex(n + r.length)] = this._array[
      ...
      var i = (function () {
        ...
        return (
          Object.defineProperty(e.prototype, "isFocused", {
            get: function () {
              return (
                document.activeElement === this._textarea && document.hasFocus()
              );
            },
            enumerable: !0,
            configurable: !0,
