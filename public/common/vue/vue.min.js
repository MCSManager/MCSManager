...
!(function (t, e) {
      ...
      fr(t, {
        ...
        chars: function (t) {
          if (
            ...
            if (
              (t =
                c || t.trim() ? (Tr(i) ? t : Ns(t)) : a && e.length ? " " : "")
            ) {
              var n;
              !s && " " !== t && (n = ur(t, us))
  ...
  function Xr(t, e, n) {
    ...
    return (
      (e.forProcessed = !0),
      "_l((" + r + "),function(" + i + o + a + "){return " + Qr(t, e, n) + "})"
    );
  }
    ...
    wo = {
      init: function (t, e, n, r) {
        if (!t.componentInstance || t.componentInstance._isDestroyed)
          (t.componentInstance = Yt(t, lo, n, r)).$mount(e ? t.elm : void 0, e);
          ...
          if (t(r)) (f = !0), c(i, p, u, l);
            ...
            if (!d && He(r, i)) w(r, i, p, s);
              ...
              var v = r.elm,
                m = E.parentNode(v);
              if (
                (c(i, p, v._leaveCb ? null : m, E.nextSibling(v)), e(i.parent))
              ) {
  ...
  return (
    (_e.prototype.$mount = function (t, e) {
      if ((t = t && Fe(t)) === document.body || t === document.documentElement)
        return this;
      var n = this.$options;
      if (!n.render) {
        var r = n.template;
